...
class CidadeResourceIT {
    ...
    @Test
    @Transactional
    void getAllCidadesByEstabelecimentoIsEqualToSomething() throws Exception {
        ...
        em.flush();
        cidade.addEstabelecimento(estabelecimento);
        cidadeRepository.saveAndFlush(cidade);
        Long estabelecimentoId = estabelecimento.getId();
        // Get all the cidadeList where estabelecimento equals to estabelecimentoId
        defaultCidadeShouldBeFound("estabelecimentoId.equals=" + estabelecimentoId);

        // Get all the cidadeList where estabelecimento equals to (estabelecimentoId + 1)
        defaultCidadeShouldNotBeFound("estabelecimentoId.equals=" + (estabelecimentoId + 1));
    }
