...
describe('Imagens Management Component', () => {
  let comp: ImagensComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'imagens', component: ImagensComponent }]),
      ...
      .overrideTemplate(ImagensComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to imagensService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getImagensIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getImagensIdentifier).toHaveBeenCalledWith(entity);
