...
describe('Estabelecimento Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'estabelecimento', component: EstabelecimentoComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.estabelecimentos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
