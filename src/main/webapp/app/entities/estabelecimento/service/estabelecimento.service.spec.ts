...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../estabelecimento.test-samples';

import { EstabelecimentoService, RestEstabelecimento } from './estabelecimento.service';

const requireRestSample: RestEstabelecimento = {
  ...sampleWithRequiredData,
  criadoEm: sampleWithRequiredData.criadoEm?.toJSON(),
};
