...
describe('Estabelecimento Management Detail Component', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [EstabelecimentoDetailComponent, RouterTestingModule.withRoutes([], { bindToComponentInputs: true })],
      providers: [
        provideRouter(
          [
            {
              ...
              resolve: { estabelecimento: () => of({ id: 123 }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load estabelecimento on init', async () => {
      ...
      // THEN
      expect(instance.estabelecimento).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
  ...
  describe('byteSize', () => {
    it('Should call byteSize from DataUtils', () => {
      ...
      const fixture = TestBed.createComponent(EstabelecimentoDetailComponent);
