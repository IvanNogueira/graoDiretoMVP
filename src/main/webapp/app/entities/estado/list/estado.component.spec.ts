...
describe('Estado Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'estado', component: EstadoComponent }]), HttpClientTestingModule, EstadoComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to estadoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEstadoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEstadoIdentifier).toHaveBeenCalledWith(entity);
