...
describe('Cardapio Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'cardapio', component: CardapioComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to cardapioService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCardapioIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCardapioIdentifier).toHaveBeenCalledWith(entity);
